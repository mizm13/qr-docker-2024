...
FILL_COLOR = os.getenv('FILL_COLOR', 'purple')  # Fill color for the QR code
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/mizm13')
